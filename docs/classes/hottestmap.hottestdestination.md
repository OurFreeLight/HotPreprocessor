...
Defined in: [HotTestMap.ts:23](https://github.com/OurFreeLight/HotPreprocessor/blob/042e7cd/src/HotTestMap.ts#L23)
...
Defined in: [HotTestMap.ts:18](https://github.com/OurFreeLight/HotPreprocessor/blob/042e7cd/src/HotTestMap.ts#L18)
